...
method inputCompanyScreen(aData) class LibEnvironmentObj
  ...
  DEFINE MSDIALOG oDlg FROM 0, 0 TO 135, 305 TITLE "Informe a Empresa e Filial" PIXEL
...
@since 17/05/2023
/*/
method adminLoginScreen() class LibEnvironmentObj
